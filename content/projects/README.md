...
1. **[Artist landing: HTML, CSS, SEO and accessibility](/ai-engineering-syllabus/content/projects/html-css-artist-landing-seo-access)**  
   Accessible, SEO-optimized landing page for an artist using semantic HTML and CSS.

2. **[Simple dashboard with Tailwind CSS](/ai-engineering-syllabus/content/projects/first-dashboard-tailwind-css)**  
